...
import { Droplets, Bell, History, Map, Settings, HelpCircle, User, LogOut, AlertTriangle, Power, Gauge } from 'lucide-react';
      ...
      <div className="w-full md:w-64 bg-white shadow-lg">
        <div className="p-4">
          ...
          <nav className="space-y-2">
            <a href="#" className="flex items-center space-x-3 p-3 bg-blue-50 text-blue-700 rounded-lg">
              <Gauge className="h-5 w-5" />
              <span>Dashboard</span>
            </a>
            <a href="#" className="flex items-center space-x-3 p-3 hover:bg-gray-50 rounded-lg">
            ...
            <button onClick={handleLogout} className="flex items-center space-x-3 p-3 hover:bg-gray-50 rounded-lg w-full text-left text-red-600">
